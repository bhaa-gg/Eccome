...
export default function Nav() {
    let { setDataWList, setIdW, counterWList, setCounterWList, getUserWishlist, counter, setCounter, ShowDataCart } = useContext(conText);
            ...
            <nav className="navbar navbar-expand-lg bg-body-secondary py-3 ">
                <div className="container-fluid mx-2">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav m-auto gap-3 mb-2 mb-lg-0">
                    ...
                    <ul className="navbar-nav me-auto mb-2 gap-3 ms-auto mb-lg-0">
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink className=" nav-link btn  fs-5  position-relative" to="/WhichList">
                        ...
                        <li className="nav-item">
                            <Link onClick={logout} className=" nav-link btn fs-5    position-relative" to="/Signin">
