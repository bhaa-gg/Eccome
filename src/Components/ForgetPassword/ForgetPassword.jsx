            ...
            <Modal backdrop="static" keyboard={false} size="lg" aria-labelledby="contained-modal-title-vcenter" centered show={show} onHide={handleClose} animation={false}>
                ...
                <Modal.Body>
                    <div className="container-fluid">
                        <form  >
                            <input type="text" name='resetCode' onChange={reset.handleChange} onBlur={reset.handleBlur} className='form-control' placeholder='Code To Reser Password ...' />
                        </form>
                    </div>
                </Modal.Body>
                <Modal.Footer>
            ...
            <div>
                <div className="w-75 m-auto">
                    ...
                    <form onSubmit={register.handleSubmit}>
                        ...
                        <input onChange={register.handleChange} placeholder='Email...' onBlur={register.handleBlur} type="email" id='email' name='email' className={` mt-3 mb-4 form-control ${register.errors.email && register.touched.email ? "is-invalid" : ""}  `} />
